...
app.post("/", (req, res) => {
  const URL = `https://api.openweathermap.org/data/2.5/weather?q=${req.body.city}&appid=6b520230906d018eb63bae96f032f461&units=metric`;
            ...
            <div class="container-fuild">
              <div class="row">
                <div class="col-lg-8 title-column">
                  <h1>Welcome to the temperature monitor</h1>
                </div>
